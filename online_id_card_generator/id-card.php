                             ...
                             $html.="
                                        ...
                                        <div class='container' style='text-align:left; border:2px dotted black;'>
                                              ...
                                              <div class='container-2'>
                                                  ...
                                                  <div class='box-2'>
                                                      <h2>$name</h2>
                                                      <p style='font-size: 14px; color: red'>STUDENT</p>
                                                  </div>
                                                  <div class='box-3'>
                                              ...
                                              <div class='container-3'>
                                                  ...
                                                  <div class='info-4'>
                                                      <div class='sign'>
                                                          <br>
                                                          <p style='font-size:12px;    margin-bottom: 8px;'></p>
                                                        <p style='font-family: Dancing Script'></p>
...
.header {
    ...
    /* box-shadow: 0 1px 10px rgb(146 161 176 / 50%); */
    /* border-radius: 10px; */
    background-image: url(assets/images/pandu.png);
    overflow: hidden;
